...
<body>
  ...
  <section data-bs-version="5.1" class="form7 cid-tHEmHiqIDV" id="form7-s">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="" method="POST" class="mbr-form form-with-styler mx-auto" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="lj2LYKlG6Zt8HQZ8fQdQL6egyosEJ1cmumCiYvqtG75vwGuebPW6e4sXGSoRPyn32wdubferx+GayokNvbGmF494EtIO68xoH0SchUcBgEMdQdEgh3FzpAzAPvfrizd/">
...
<label>
<span class="textGDPR display-7" style="color: #a7a7a7"><input type="checkbox" name="gdpr" id="gdpr-form7-s" required="">By continuing you agree to our <a style="color: #232323; text-decoration: none;" href="terms.html">Terms of Service</a> and <a style="color: #232323; text-decoration: none;" href="policy.html">Privacy Policy</a>.</span>
</label>
</span></form>
            </div>
        </div>
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-black display-4" href="">Contacts</a>
                    </li></ul>

                <div class="navbar-buttons mbr-section-btn"><a class="btn btn-black display-4" href="">Connexion</a></div>
            </div>
        </div>
    </nav>
</section>

<section data-bs-version="5.1" class="footer7 cid-tHD9hj4frv" once="footers" id="footer7-q">
